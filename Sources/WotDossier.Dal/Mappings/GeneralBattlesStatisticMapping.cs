...
{
    /// <summary>
    /// Represents map class for <see cref="GeneralBattlesStatisticEntity"/>.
    /// </summary>
    public class GeneralBattlesStatisticMapping : StatisticClassMapBase<GeneralBattlesStatisticEntity>
    {
        public GeneralBattlesStatisticMapping()
        {
