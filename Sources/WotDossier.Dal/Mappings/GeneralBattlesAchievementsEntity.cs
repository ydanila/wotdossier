...
{
    /// <summary>
    /// Represents map class for <see cref="GeneralBattlesAchievementsEntity"/>.
    /// </summary>
    public class GeneralBattlesAchievementsEntityMapping : ClassMapBase<GeneralBattlesAchievementsEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralBattlesAchievementsEntityMapping"/> class.
        /// </summary>
        public GeneralBattlesAchievementsEntityMapping()
        {
            Map(v => v.UId);
            Map(v => v.Warrior);
            Map(v => v.Sniper);
