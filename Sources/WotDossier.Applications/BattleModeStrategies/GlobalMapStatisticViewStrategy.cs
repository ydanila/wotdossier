...
{
    public class GlobalMapStatisticViewStrategy : StatisticViewStrategyBase
    {
        ...
        public GlobalMapStatisticViewStrategy(DossierRepository dossierRepository) : base(dossierRepository)
        {
        }
        ...
        {
            return new GlobalMapTankStatisticRowViewModel(currentStatistic, prevStatisticViewModels);
        }
        ...
        {
            return new GlobalMapBattlesPlayerStatisticViewModel((RandomBattlesStatisticEntity)currentStatistic);
        }
        ...
        {
            return new GlobalMapBattlesPlayerStatisticViewModel((RandomBattlesStatisticEntity)currentStatistic, oldStatisticEntities);
        }
        ...
        public override PlayerEntity UpdatePlayerStatistic(int playerId, List<TankJson> tanks, Player serverStatistic)
        {
            ...
            GlobalMapBattlesStatAdapter newSnapshot = new GlobalMapBattlesStatAdapter(tanks);
