...
{
    public class FalloutStatisticViewStrategy : StatisticViewStrategyBase
    {
        ...
        public FalloutStatisticViewStrategy(DossierRepository dossierRepository)
        ...
        {
            return new FalloutBattlesTankStatisticRowViewModel(currentStatistic, prevStatisticViewModels);
        }
        ...
        {
            return new FalloutBattlesPlayerStatisticViewModel((RandomBattlesStatisticEntity)currentStatistic);
        }
        ...
        {
            return new FalloutBattlesPlayerStatisticViewModel((RandomBattlesStatisticEntity)currentStatistic, oldStatisticEntities);
        }
        ...
        public override PlayerEntity UpdatePlayerStatistic(int playerId, List<TankJson> tanks, Player serverStatistic)
        {
            ...
            FalloutBattlesStatAdapter newSnapshot = new FalloutBattlesStatAdapter(tanks);
