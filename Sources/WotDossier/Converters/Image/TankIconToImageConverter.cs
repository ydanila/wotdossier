...
namespace WotDossier.Converters
{
    public class TankIconToImageConverter : IValueConverter
    {
        ...
        {
            TankDescription tank = (TankDescription)value;

	        if (tank != null)
            {
                Uri uriSource = new Uri(string.Format($@"pack://application:,,,/WotDossier.Resources;component/Vehicles/Images/Vehicle/{tank.IconId}.png"));
                return ImageCache.GetBitmapImage(uriSource);
            }
